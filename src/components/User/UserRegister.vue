...
async function handleSubmit(){
    ...
    try {
        ...
        if (response.status == 200) {
            await alertSuccess(`Registration successful! Welcome, ${user.name}!`);
            await router.push({
                path: '/login',
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="username" name="username" 
                        ...
                        placeholder="Choose a username" v-model="user.username" required>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="text" id="name" name="name" 
                        class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" 
                        placeholder="Enter your full name" v-model="user.name" required>
                </div>
            </div>
            ...
            <div class="mb-4">
                ...
                <div class="relative">
                    ...
                    <input type="password" id="password" name="password" 
                        class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" 
                        placeholder="Create a password" v-model="user.password" required>
                </div>
            </div>
            ...
            <div class="mb-6">
                ...
                <div class="relative">
                    ...
                    <input type="password" id="confirm_password" name="confirm_password" 
                        class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" 
                        placeholder="Confirm your password" v-model="user.confirmPassword" required>
                </div>
            </div>
