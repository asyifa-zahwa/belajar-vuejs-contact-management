...
async function fetchUser(){
    ...
    if (response.status === 200) {
        ...
        await alertError('Failed to fetch user details');
        console.error('Failed to fetch user details:', responseBody.errors);
    }
}

async function handleChangeName() {
    // Logic to change the user's name
    console.log('Changing name to:', name.value);
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-gray-800 bg-opacity-80 rounded-xl shadow-custom border border-gray-700 overflow-hidden card-hover animate-fade-in">
                <div class="p-6">
                    ...
                    <form @submit.prevent="handleChangeName" class="space-y-6">
                        <div class="mb-5">
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="new_password" name="new_password" 
                                    class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" 
                                    placeholder="Enter your new password" v-model="password" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-5">
                            ...
                            <div class="relative">
                                ...
                                <input type="password" id="confirm_password" name="confirm_password" 
                                    class="w-full pl-10 pr-3 py-3 bg-gray-700 bg-opacity-50 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200" 
                                    placeholder="Confirm your new password" v-model="confirmPassword" required>
                            </div>
                        </div>
