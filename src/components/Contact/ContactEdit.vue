...
async function handleSubmit() {
    ...
    // This function can be used to save the edited contact details
    const response = await contactUpdate(token.value, id, contact);
    const responseBody = await response.json();
    console.log('Edit contact response:', responseBody);
...
async function fetchContact() {
    ...
    // This function can be used to fetch contact details for editing
